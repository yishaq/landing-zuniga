        ...
        <div className="space-y-16">
          ...
          <div key={categoryIndex}>
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.6, delay: index * 0.1 }} className="bg-white pt-8 pr-8 pb-5 pl-8 rounded-3xl border border-slate-200 group relative hover:shadow-xl transition-all duration-500">
